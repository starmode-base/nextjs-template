  ...
  return (
    <main className="flex h-dvh flex-col items-center justify-center gap-10 p-5">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-center text-4xl font-bold">template-nextjs</h1>
        <a
          className="text-center underline hover:no-underline"
          href="https://github.com/starmode-base/template-nextjs"
          target="_blank"
        >
          https://github.com/starmode-base/template-nextjs
        </a>
      </div>
    </main>
  );
